...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        bindPreferenceSummaryToValue(findPreference("ice_name_text"));
    }
    ...
    protected boolean isValidFragment(String fragmentName) {
        SRLOG.v(TAG, "Checking if valid: "+fragmentName);
        return "com.cpiekarski.fourteeners.activities.SettingsActivity$GeneralPreferenceFragment".equals(fragmentName) ||
                "com.cpiekarski.fourteeners.activities.SettingsActivity$ICEPreferenceFragment".equals(fragmentName);
      }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("general_name_text"));
        }
    }
    ...
    public static class ICEPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("ice_name_text"));
            bindPreferenceSummaryToValue(findPreference("ice_name_email"));
            bindPreferenceSummaryToValue(findPreference("ice_name_number"));
        }
    }
}
